...
const cotacoes = eua.concat(dolar, dx, emergentes, europa, asia, cryptos, latam, brasil, commodities, curva_eua);
export const codigos_cotacoes = cotacoes.map(cotacao => `pid-${cotacao.pid}:`);